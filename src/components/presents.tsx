...
export default function App() {
  const list = [
    {
      title: "Fones",
      img: "/images/fones_de_ouvido.png",
      price: "R$179.00",
    ...
    },
    {
      ...
      img: "/images/mesa_para_computador.png",
      price: "R$219.00",
